const data = [
    ...
    /*1*/{ label: "Name, Surname", description: null, isRequired: true, name: "firstLastName", placeholder: "Ваша відповідь" },
    /*2*/{ label: "Your team", description: null, isRequired: true, name: "nameTeam", placeholder: "Ваша відповідь" },
    /*3*/{
    ...
    /*5*/{ label: "My current level on tech" },
    /*6*/{
    ...
    /*8*/{ label: "#2 My goals on next time", description: null, isRequired: true, name: "goals_two", placeholder: "Ваша відповідь" },
    /*9*/{ label: "#3 My goals on next time", description: null, isRequired: true, name: "goals_three", placeholder: "Ваша відповідь" },
    /*10*/{
